...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree = ttk.Treeview(
            self, columns=("id", "name", "phone number", "email", "salary"), height=45, show="headings"
        )

        self.tree.column("id", width=20, anchor=tk.CENTER)
        self.tree.column("name", width=140, anchor=tk.CENTER)
        self.tree.column("phone number", width=250, anchor=tk.CENTER)
        self.tree.column("email", width=150, anchor=tk.CENTER)
        self.tree.column("salary", width=100, anchor=tk.CENTER)

        self.tree.heading("id", text="ID")
        self.tree.heading("name", text="ФИО")
        self.tree.heading("phone number", text="Номер телейфона")
